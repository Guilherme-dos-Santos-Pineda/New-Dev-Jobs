...
const EN = {
    ...
    'Como o New Dev Jobs funciona': 'How New Dev Jobs works',
    ...
    'Relato enviado': 'Report sent',
    'Obrigado. Vamos investigar e você pode acompanhar o status em Feedback.': "Thanks. We'll look into it and you can follow the status under Feedback.",
    'O que aconteceu? Se puder, diga o que você estava tentando fazer e o que esperava que acontecesse.': 'What happened? If you can, tell us what you were trying to do and what you expected.',
    'Ex.: cliquei em "enviar candidaturas" e a tela ficou carregando para sempre.': 'e.g. I clicked "send applications" and the screen loaded forever.',
    'Enviamos junto alguns dados técnicos': 'We also send some technical details',
    'Descreva o problema com um pouco mais de detalhe.': 'Please describe the problem in a bit more detail.',
    'Não foi possível enviar. Tente de novo.': 'Could not send. Please try again.',
    'Página': 'Page',
    'Tela': 'Screen',
    'Navegador': 'Browser',
